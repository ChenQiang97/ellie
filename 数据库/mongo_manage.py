...
MONGO_USERNAME = None
MONGO_PASSWORD = None
MONGO_DB = 'crawler_admin_test'
MONGO_AUTH_DB = 'crawler_admin_test'
...
class DbManager(object):
    ...
    def update(self, col_name: str, cond: dict, values: dict, **kwargs):
        ...
        """
        col = self.db[col_name]
        update_result = col.update(cond, {'$set': values}, **kwargs)
    ...
    def update_one(self, col_name: str, id: str, values: dict, **kwargs):
        ...
        # update_result = col.find_one_and_update({'_id': _id}, {'$set': values})
        update_result = col.update_one({'_id': _id}, {'$set': values})
        return update_result
